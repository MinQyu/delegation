...
!(function (D, u) {
  ...
  function C(D, u, e, F, i, C, n) {
    var s,
      ...
      Q = "flex" === v.display,
      U = D.style.display;
    for (J && (I = I.split("++").join("")), Q && (D.style.display = "block"), r = (E = D.getElementsByTagName("*")).length, l = [], s = 0; s < r; s++)
      l[s] = E[s];
    if (R || G)
      for (s = 0; s < r; s++)
        ((d = (o = l[s]).parentNode === D) || G || (q && !P)) &&
          ((m = o.offsetTop),
          R && d && Math.abs(m - _) > L && ("BR" !== o.nodeName || 0 === s) && ((a = []), R.push(a), (_ = m)),
          G && ((o._x = o.offsetLeft), (o._y = m), (o._w = o.offsetWidth), (o._h = o.offsetHeight)),
          R &&
            (((o._isSplit && d) || (!q && d) || (P && d) || (!P && o.parentNode.parentNode === D && !o.parentNode._isSplit)) &&
              (a.push(o), (o._x -= w), z(o, D, k) && (o._wordEnd = !0)),
            "BR" === o.nodeName && ((o.nextSibling && "BR" === o.nextSibling.nodeName) || 0 === s) && R.push([])));
    for (s = 0; s < r; s++)
      if (((d = (o = l[s]).parentNode === D), "BR" !== o.nodeName))
        if (
          ...
          if (o._isSplit)
            for (o._next = E = o.nextSibling, o.parentNode.appendChild(o); E && 3 === E.nodeType && " " === E.textContent; )
              (o._next = E.nextSibling), o.parentNode.appendChild(E), (E = E.nextSibling);
          else
          ...
          o.parentNode._isSplit && !o._isSplit && "" !== o.innerHTML
            ? H.push(o)
            : q && !o._isSplit && ("span" === V && (o.style.display = "inline"), O.push(o));
      else R || G ? (o.parentNode && o.parentNode.removeChild(o), l.splice(s--, 1), r--) : P || D.appendChild(o);
    for (s = K.length; -1 < --s; ) K[s].parentNode.removeChild(K[s]);
    if (R) {
      for (
        G &&
          ((c = X.createElement(V)), D.appendChild(c), (g = c.offsetWidth + "px"), (m = c.offsetParent === D ? 0 : D.offsetLeft), D.removeChild(c)),
          f = D.style.cssText,
      ...
      for (h = " " === k && (!G || (!P && !q)), s = 0; s < R.length; s++) {
        for (
          a = R[s],
            (c = X.createElement(V)).style.cssText = "display:block;text-align:" + W + ";position:" + (G ? "absolute;" : "relative;"),
          ...
          "BR" !== a[E].nodeName &&
            ...
            G &&
              (0 === E && ((c.style.top = o._y + "px"), (c.style.left = w + m + "px")),
              (o.style.top = "0px"),
              m && (o.style.left = o._x - m + "px")));
        0 === r ? (c.innerHTML = "&nbsp;") : P || q || (A(c), x(c, String.fromCharCode(160), " ")),
    ...
    G &&
      (n > D.clientHeight && ((D.style.height = n - T + "px"), D.clientHeight < n && (D.style.height = n + S + "px")),
      C > D.clientWidth && ((D.style.width = C - N + "px"), D.clientWidth < C && (D.style.width = C + b + "px"))),
  ...
  function D(D, e, F, i) {
    ...
    for (
      ...
      if (((o = C.charAt(s)), g && (d = g(C.substr(s), e.specialChars))))
        (o = C.substr(s, d || 1)), (n += p && " " !== o ? i() + o + "</" + a + ">" : o), (s += d - 1);
        ...
        "{" === o && "{{LT}}" === C.substr(s, 6)
          ...
          ? ((E = ((C.substr(s, 12).split(v) || [])[1] || "").length || 2),
            (n += p && " " !== o ? i() + C.substr(s, E) + "</" + a + ">" : C.substr(s, E)),
            (s += E - 1))
          : (n += p && " " !== o ? i() + o + "</" + a + ">" : o);
      ...
      for (e.absolute = !1, C = 0; C < o; C++)
        ((n = r[C])._next = n._isFirst = n._parent = n._wordEnd = null),
          (3 === n.nodeType && !/\S+/.test(n.nodeValue)) ||
            (l && 3 !== n.nodeType && "inline" === p(n).display && ((n.style.display = "inline-block"), (n.style.position = "relative")),
            (n._isSplit = !0),
            E(n, e, F, i));
  ...
  var X,
    ...
    h =
      (((n = SplitText.prototype).split = function split(D) {
        ...
        for (
          var u, e, t, F = this.elements.length, i = D.tag ? D.tag : D.span ? "span" : "div", n = w(D.wordsClass, i), s = w(D.charsClass, i);
          -1 < --F;
